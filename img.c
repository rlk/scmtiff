...
double img_equirectangular(img *p, double lon, double lat, double *c)
{
...
double img_orthographic(img *p, double lon, double lat, double *c)
{
...
double img_stereographic(img *p, double lon, double lat, double *c)
{
    double x;
    double y;
...
double img_cylindrical(img *p, double lon, double lat, double *c)
{
...
double img_default(img *p, double lon, double lat, double *c)
{
...
double img_sample(img *p, const double *v, double *c)
{
